...
public class OrderListParam implements org.apache.thrift.TBase<OrderListParam, OrderListParam._Fields>, java.io.Serializable, Cloneable, Comparable<OrderListParam> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("OrderListParam");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new OrderListParamStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new OrderListParamTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(OrderListParam.class, metaDataMap);
  }
   ...
   */
  public OrderListParam(OrderListParam other) {
  ...
  public OrderListParam deepCopy() {
    return new OrderListParam(this);
  }
  ...
  public OrderListParam setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public OrderListParam setPageNumber(int pageNumber) {
    this.pageNumber = pageNumber;
    setPageNumberIsSet(true);
    return this;
  }
  ...
  public OrderListParam setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof OrderListParam)
      return this.equals((OrderListParam)that);
    return false;
  }

  public boolean equals(OrderListParam that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(OrderListParam other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("OrderListParam(");
    boolean first = true;
  ...
  private static class OrderListParamStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public OrderListParamStandardScheme getScheme() {
      return new OrderListParamStandardScheme();
    }
  }

  private static class OrderListParamStandardScheme extends org.apache.thrift.scheme.StandardScheme<OrderListParam> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, OrderListParam struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OrderListParam struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class OrderListParamTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public OrderListParamTupleScheme getScheme() {
      return new OrderListParamTupleScheme();
    }
  }

  private static class OrderListParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<OrderListParam> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, OrderListParam struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, OrderListParam struct) throws org.apache.thrift.TException {
