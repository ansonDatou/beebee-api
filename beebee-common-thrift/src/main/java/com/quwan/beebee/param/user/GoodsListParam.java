...
public class GoodsListParam implements org.apache.thrift.TBase<GoodsListParam, GoodsListParam._Fields>, java.io.Serializable, Cloneable, Comparable<GoodsListParam> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GoodsListParam");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GoodsListParamStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GoodsListParamTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GoodsListParam.class, metaDataMap);
  }

  public GoodsListParam() {
  }
   ...
   */
  public GoodsListParam(GoodsListParam other) {
    __isset_bitfield = other.__isset_bitfield;
    this.pageNumber = other.pageNumber;
    this.pageSize = other.pageSize;
  }

  public GoodsListParam deepCopy() {
    return new GoodsListParam(this);
  }
  ...
  public GoodsListParam setPageNumber(int pageNumber) {
    this.pageNumber = pageNumber;
    setPageNumberIsSet(true);
    return this;
  }
  ...
  public GoodsListParam setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GoodsListParam)
      return this.equals((GoodsListParam)that);
    return false;
  }

  public boolean equals(GoodsListParam that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GoodsListParam other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GoodsListParam(");
    boolean first = true;
  ...
  private static class GoodsListParamStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GoodsListParamStandardScheme getScheme() {
      return new GoodsListParamStandardScheme();
    }
  }

  private static class GoodsListParamStandardScheme extends org.apache.thrift.scheme.StandardScheme<GoodsListParam> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GoodsListParam struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GoodsListParam struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GoodsListParamTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GoodsListParamTupleScheme getScheme() {
      return new GoodsListParamTupleScheme();
    }
  }

  private static class GoodsListParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<GoodsListParam> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GoodsListParam struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GoodsListParam struct) throws org.apache.thrift.TException {
