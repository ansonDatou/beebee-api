...
public class TopicBarrageListParam implements org.apache.thrift.TBase<TopicBarrageListParam, TopicBarrageListParam._Fields>, java.io.Serializable, Cloneable, Comparable<TopicBarrageListParam> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TopicBarrageListParam");
  ...
  private static final org.apache.thrift.protocol.TField SORT_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("sortType", org.apache.thrift.protocol.TType.I32, (short)3);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TopicBarrageListParamStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TopicBarrageListParamTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TopicBarrageListParam.class, metaDataMap);
  }

  public TopicBarrageListParam() {
  }
   ...
   */
  public TopicBarrageListParam(TopicBarrageListParam other) {
  ...
  public TopicBarrageListParam deepCopy() {
    return new TopicBarrageListParam(this);
  }
  ...
  public TopicBarrageListParam setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public TopicBarrageListParam setTopicId(int topicId) {
    this.topicId = topicId;
    setTopicIdIsSet(true);
    return this;
  }
  ...
  public TopicBarrageListParam setSortType(int sortType) {
    this.sortType = sortType;
    setSortTypeIsSet(true);
    return this;
  }
  ...
  public TopicBarrageListParam setPageNumber(int pageNumber) {
    this.pageNumber = pageNumber;
    setPageNumberIsSet(true);
    return this;
  }
  ...
  public TopicBarrageListParam setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TopicBarrageListParam)
      return this.equals((TopicBarrageListParam)that);
    return false;
  }

  public boolean equals(TopicBarrageListParam that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TopicBarrageListParam other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TopicBarrageListParam(");
    boolean first = true;
  ...
  private static class TopicBarrageListParamStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TopicBarrageListParamStandardScheme getScheme() {
      return new TopicBarrageListParamStandardScheme();
    }
  }

  private static class TopicBarrageListParamStandardScheme extends org.apache.thrift.scheme.StandardScheme<TopicBarrageListParam> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TopicBarrageListParam struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopicBarrageListParam struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TopicBarrageListParamTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TopicBarrageListParamTupleScheme getScheme() {
      return new TopicBarrageListParamTupleScheme();
    }
  }

  private static class TopicBarrageListParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<TopicBarrageListParam> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TopicBarrageListParam struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TopicBarrageListParam struct) throws org.apache.thrift.TException {
