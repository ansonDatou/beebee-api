...
public class Sms {
    ...
    static final String accessKeyId = "LTAI5AzKqm6c4gc5";
    static final String accessKeySecret = "JOz9wSb37pYVYtgtiQTbw2r1ufFV2z";
    ...
    public static SendSmsResponse sendSms(String mobile, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("蜜蜂说");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_109350312");
...
//
//        //发短信
//        SendSmsResponse resp = sendSms("18511551331", "2222");
...
//            QuerySendDetailsResponse querySendDetailsResponse = querySendDetails(resp.getBizId(), "18511551331");
